...
describe("Cart", () => {
  ...
  test("should be 30.4euros", () => {
    addBook(0);
    addBook(1);
    addBook(0);
    addBook(1);

    expect(cart(books)).toBe(30.4);
  });

  test("should be 39.52euros", () => {
    addBook(0);
    addBook(1);
    addBook(2);
    addBook(3);
    ...
    expect(cart(books)).toBe(40.8);
  });

  
  test("should be 141.2", () => {
    addBook(0);
    addBook(0);
    addBook(0);
    addBook(0);
